...
class fm_receiver(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Lesson 3 - FM Rx", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Lesson 3 - FM Rx")
        ...
        self._freq_range = Range(600e3, 2000e3, 10e3, 1260e3, 200)
        ...
        self.blocks_selector_0_0 = blocks.selector(gr.sizeof_gr_complex*1,0,amfm)
        ...
        self.connect((self.blocks_selector_0_0, 0), (self.analog_am_demod_cf_0, 0))
        self.connect((self.blocks_selector_0_0, 1), (self.analog_wfm_rcv_0, 0))
    ...
    def set_amfm(self, amfm):
        self.amfm = amfm
        self._amfm_callback(self.amfm)
        self.blocks_selector_0_0.set_output_index(self.amfm)
