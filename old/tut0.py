...
class tut0(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "tut0")
        ...
        self._frequency_range = Range(-16000, 16000, 100, 0, 200)
...
def main(top_block_cls=tut0, options=None):
