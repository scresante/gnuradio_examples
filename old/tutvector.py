...
class tutvector(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "tut vector", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("tut vector")
        ...
        self.settings = Qt.QSettings("GNU Radio", "tutvector")
        ...
        self.connect((self.analog_sig_source_x_0_0, 0), (self.blocks_streams_to_vector_0, 0))
        ...
        self.connect((self.blocks_vector_to_stream_0, 0), (self.qtgui_time_sink_x_0_0_0, 0))
...
def main(top_block_cls=tutvector, options=None):
